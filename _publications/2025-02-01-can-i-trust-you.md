...
display_status: 'ApJS · under revision'
contribution: 'Built the CNN and LIME audit workflow, reviewed 650 images, evaluated source-level folds, and analyzed data and model failure modes.'
project_url: '/portfolio/2024-12-01-frdeep-xai/'
thumbnail: '/images/projects/frdeep-method.png'
thumbnail_alt: 'Radio galaxy image compared across segmentation methods used for LIME explanations'
